...
//#define PRA32_U_ControlPanel_init_display_SSD1309();
...
#if defined(PRA32_U_OLED_IS_SSD1309)
    PRA32_U_ControlPanel_init_display_SSD1309(); // инициализация SSD1309
    PRA32_U_ControlPanel_normal_mode();          // на всякий случай нормальный режим
  #endif
